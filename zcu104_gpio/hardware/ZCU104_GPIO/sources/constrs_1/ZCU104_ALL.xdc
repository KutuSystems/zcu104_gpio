...
set_property PACKAGE_PIN E4  [get_ports {gpio_dip[0]}]
set_property PACKAGE_PIN D4  [get_ports {gpio_dip[1]}]
set_property PACKAGE_PIN F5  [get_ports {gpio_dip[2]}]
set_property PACKAGE_PIN F4  [get_ports {gpio_dip[3]}]

set_property IOSTANDARD LVCMOS33 [get_ports gpio_pb*]
set_property PACKAGE_PIN B4  [get_ports {gpio_pb[0]}]
set_property PACKAGE_PIN C4  [get_ports {gpio_pb[1]}]
set_property PACKAGE_PIN B3  [get_ports {gpio_pb[2]}]
set_property PACKAGE_PIN C3  [get_ports {gpio_pb[3]}]
